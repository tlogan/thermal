...
**
**        (* TODO: check mode: if effect mode, then eval effect and continue with continuation *)
...
*)
  ...
  fun eval t = (let
    ...
    (*
    ** just eval effect once cont_stack is empty!
    ** what about events? no worries, just turn them into effects with sync
    *)
